...
function flattenUntrackedRoots(nodes: Record<string, TreeNode>): Record<string, TreeNode> {
  const result = {};
 ...
 * Utilities
 * ------------------------------------------------------------------ */
function filterTree(node: TreeNode, filter: { type: string; username: string }): TreeNode | null {
