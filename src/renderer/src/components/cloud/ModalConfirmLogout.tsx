...
const ModalConfirmDelete = ({ cancelDelete, confirmDelete }: ModalConfirmDeleteProps): React.ReactElement => {
  return (
    <div className="fixed inset-0 z-15 flex items-center justify-center dark:bg-gray-900/50">
      ...
      <div className="relative z-10 w-full max-w-sm rounded-lg bg-white p-6 shadow-lg dark:bg-gray-800">
        <h2 className="mb-4 text-lg font-semibold dark:text-gray-200">Confirm Delete Cloud Provider</h2>
        <p className="mb-6 dark:text-gray-200">Do you want to delete this cloud provider?</p>
